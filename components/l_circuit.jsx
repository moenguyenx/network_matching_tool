...
function ZinLessThanZload ({L1, C1, Z1, C2, L2}) {
    return (
        <div class="circuit-image-area">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="circuit-image" style={{marginLeft: "1rem", marginRight: "0.5rem"}}>
                          ...
                          <text class="refdes" text-anchor="middle" x="45" y="-15">L<sub>1</sub></text>
...
function ZinMoreThanZload({L1, C1, Z1, C2, L2}) {
    return (
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="circuit-image" style={{marginLeft: "2rem", marginRight: "0.5rem"}}>
    <g class="circuit-group" font-family="Arial" transform="translate(0,10)">
